...
economy = {
	...
	MIN_NUM_FACTORIES_PER_STATE_BEFORE_DELETING_LASSIEZ_FAIRE = 9, -- Min number of factories per state before starting to delete under Lassiez Faire
...
military = {
	...
	AI_BIGSHIP_PROPORTION = 0, -- fraction of ships in the navy that should be ships of the line
	...
	AI_SPECIAL_PROPORTION = 0, -- fraction of brigades that should be engineers and tanks
...
ai =
{
	COLONY_WEIGHT = 11.0, -- ai weight for colonising
	...
	SOLDIER_FRACTION = 0.046, -- max amount of population AI wants to be soldiers
	CLERGYMEN_FRACTION = 0.036, -- max amount of population AI wants to be clergymen
	...
	POP_PROJECT_INVESTMENT_MAX_BUDGET_FACTOR = 0.3, -- how much % of our current budget can be spend on the pop project investments.
	...
	CHANCE_BUILD_RAILROAD = 0.85, -- chances in % of AI decisions (max value 1.0)
	CHANCE_BUILD_NAVAL_BASE = 0.75,
	CHANCE_BUILD_FORT = 0.5,
	CHANCE_INVEST_POP_PROJ = 0.8,
